...
from dowham_dqn.custom_playground_env import MiniGridNet
...
if __name__ == "__main__":
    ...
    register_env("Pacman-CustomPlayground-v0",
                 lambda config: PacmanWrapper(env, prediction_net=net,
    ...
    config = (
        DQNConfig()
        .environment(env="Pacman-CustomPlayground-v0")
